...
export const metadata: Metadata = {
  title: service?.name ?? "Интернет-магазины",
  description:
    service?.shortDescription ?? "Интернет-магазины с каталогом, корзиной и оплатой.",
};
      ...
      <div className="mb-8 grid gap-6 md:grid-cols-[1.6fr,1.2fr] md:items-end">
        ...
        <div className="space-y-1.5 text-sm text-neutral-600 md:text-base">
          ...
          <p className="text-xs text-neutral-500 md:text-sm">
            Стоимость зависит от количества типов товаров, интеграций и способов
            оплаты.
          </p>
        </div>
      </div>
      ...
      <div className="grid gap-8 md:grid-cols-[1.2fr,1.4fr] md:items-start">
        <div className="space-y-3">
          <h2 className="text-lg font-semibold md:text-xl">
            Обсудить интернет-магазин под ваш бизнес
          </h2>
          <p className="max-w-md text-sm text-neutral-600 md:text-base">
            Расскажите о товарной матрице, среднем чеке и задачах продаж. Я
            предложу структуру каталога и формат магазина.
          </p>
        </div>
